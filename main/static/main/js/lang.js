const translations = {
    az: {
        ...
        viewAllNew: 'Bütün yenilikləri göstər',
        viewAllRecommended: 'Bütün tövsiyələri göstər',
        viewAllBest: 'Bütün ən yaxşıları göstər',
        noNew: 'Yenilik yoxdur.',
        noRecommended: 'Tövsiyə olunan kitab yoxdur.',
        noBest: 'Ən yaxşı kitab yoxdur.',
        searchByTitle: 'Ada görə axtar',
        applyFilters: 'Tətbiq et',
        statusNew: 'Yenilik',
        statusRecommended: 'Tövsiyə',
        statusBest: 'Ən yaxşı',
        noBooksInDb: 'Məlumat bazasında kitab yoxdur.',
        ratingLabel: 'Redaksiya reytinqi',
        noGenres: 'Janrlar tapılmadı',
        feedback: 'Əlaqə',
        noPdf: 'PDF yoxdur'
    },
    ...
    ru: {
        ...
        viewAllNew: 'Показать все новинки',
        viewAllRecommended: 'Показать все рекомендуемые',
        viewAllBest: 'Показать все лучшие',
        noNew: 'Нет новинок.',
        noRecommended: 'Нет рекомендуемых книг.',
        noBest: 'Нет лучших книг.',
        searchByTitle: 'Поиск по названию',
        applyFilters: 'Применить',
        statusNew: 'Новинка',
        statusRecommended: 'Рекомендуем',
        statusBest: 'Лучшее',
        noBooksInDb: 'Нет книг в базе данных.',
        ratingLabel: 'Рейтинг редакции',
...
const flagMap = {
    az: '/static/main/img/az.png',
    ru: '/static/main/img/ru.png'
};
